...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  const separateWords = (word: KeyTextField | undefined) => {
    if (!word) return <></>;
    return word.split('').map((singleWord: string, index: number) => (
      <span key={index} className="animate-name animate opacity-0 inline-block">
        {singleWord}
      </span>
    ));
  };
  ...
  return (
    <React.Fragment>
      <section data-slice-type={slice.slice_type}
        data-slice-variation={slice.variation} ref={container} className="bg-primary relative pt-[50px] pb-[80px]">

        <div className="container">
          <div className="grid grid-cols-2 2xl:-mx-4">
            <div className="xl:pt-12">
              ...
              <h2 className="font-Syne text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px] ">
                {separateWords(slice.primary.last_name)}</h2>
              <p className="font-Syne text-black-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-[30px] ">{slice.primary.tag_line}</p>
        ...
        <div className="hidden md:block">
          ...
          <a href="contact.html">
            <svg className="absolute bottom-[200px] lg:bottom-[80px] xl:bottom-[200px] right-[40px] lg:right-[150px] xl:right-[150px]" width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="about-section pb-[120px]">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[20px] xl:gap-[60px] items-center">
            <div className="relative">
              <ShiningImage field={slice.primary.about_image} />
            </div>
            <div className="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
              ...
              <div className="paragraph mb-6"> <PrismicRichText
                field={slice.primary.about_discription}
                fallback={<p>No content</p>}
              /></div>
              <div className="flex flex-wrap">

                <PrismicNextLink field={slice.primary.resume} className="flex items-center flex-wrap btn-primary group">Download my resume
                  <span className="inline-block ml-3 group-hover:animate-arrow-move-up">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7 17L17 7" stroke="currentColor" strokeOpacity="0.9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                      <path d="M7 7H17V17" stroke="currentColor" strokeOpacity="0.9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
